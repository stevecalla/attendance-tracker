          ...
          <Accordion.Body>
            ...
            <main className="container text-start">
              <p>
                ...
                website (“&lt;em&gt;Site&lt;/em&gt;”) and the public instance of
                the The Attendance Tracker Service made available by us, as
              ...
              <p>
                ...
                of these different ways in which we collect and use information.
              </p>
              <h2>
              ...
              <p>
                ...
                download any polyfills required in order to present the web page
                successfully in your browser.
              </p>
              <p>
                In order to provide the polyfills, the Service receives certain
                technical information from your browser including:
              </p>
              <ul>
              ...
              <ul>
                <li>
                  obfuscated IP addresses, this is an IP address with the last 3
                  digits removed or masked in order to anonymise it;
                </li>
                <li>
              ...
              <p>
                ...
                Site may include the following details relating to your visit to
                the Site:
              </p>
              <ul>
                <li>browser details;</li>
                ...
                <li>
                  connection details, for example which version of http was used
                  and how long the connection took complete;
                </li>
              </ul>
              <p>
              ...
              <p>
                ...
                basis for doing so. We rely on legitimate business interests to
                process data relating to The Attendance Tracker, for example to
                monitor compliance with the The Attendance Tracker Terms and
                Conditions. We take due care to balance our interests against
                your right to privacy.
              </p>
              <h2>Who we share your information with</h2>
              <p>
                We may share your information with organisations that provide
                services on our behalf, such as those that host the Site or the
                Service, solely for the purposes of their providing those
                services to us.
              </p>
              <p>
                We may also disclose your information to comply with applicable
                laws, court orders or other valid legal processes, and to
                enforce or apply the{" "}
                <a href={url}>
                  The Attendance Tracker Terms and Conditions
                </a>{" "}
              ...
              <p>
                ...
                Tracker service. The data that we do retain has been obfuscated
                or aggregated, for example, IP addresses have the last 3 digits
                masked once we have determined which polyfills are required by
                your browser. We retain this non-personal information for 30
                days.
              </p>
              ...
              <p>
                If you have any questions about the personal data processed as a
                result of your use of this service, please contact{" "}
              ...
              <p>
                ...
                which are not subject to this privacy policy. Websites which use
                the polyfills are not subject to this privacy policy. We are not
                responsible for third party websites’ content, use of personal
              ...
              <p>
                ...
                this page. If changes are significant, we may choose to indicate
                clearly on the{" "}
                <a href={url}>The Attendance Tracker</a> home
                page that the policy has been updated.
              </p>
            </main>
          </Accordion.Body>
        </Accordion.Item>
          ...
          <Accordion.Body>
            ...
            <main className="container text-start">
              ...
              <p>
                ...
                is operated as a community service by the The Attendance Tracker
                maintainers (“we”, “us”).
              </p>
              <h2>By using The Attendance Tracker you agree to our terms</h2>
              <p>These terms apply to “The Attendance Tracker”, which means:</p>
              <ul>
                <li>the The Attendance Tracker website (“Site”); and/or</li>
                <li>
                  the public instance of the The Attendance Tracker Service made
                  available by us, as described on the Site.
                </li>
              </ul>
              <p>
                By using The Attendance Tracker you confirm that you accept
                these terms of use and that you agree to comply with them. If
                you do not agree to these terms, you must not use The Attendance
                Tracker.
              </p>
              <p>
                ...
                future reference.{" "}
                <em>
                  Please note that these terms contain provisions which limit or
                  exclude our liability to you, in particular as set out in the
                  section headed “Our responsibility for loss or damage suffered
                  by you”.
                </em>
              </p>
              ...
              <ul>
                <li>
                  The{" "}
                  <a href={url}>
                    The Attendance Tracker privacy policy
                  </a>
                  ...
                  Attendance Tracker). If you do not agree to the terms of that
                  privacy policy then you must not use The Attendance Tracker,
                  and you should consider hosting the{" "}
                  <a
              ...
              <p>
                We do not guarantee that The Attendance Tracker, or any content
                on them, will always be available or be uninterrupted. We may
                suspend or withdraw or restrict the availability of all or any
                part of The Attendance Tracker for business and operational
                reasons.
              </p>
              <p>
              ...
              <p>
                If you require an SLA or guaranteed levels of resilience for The
                Attendance Tracker, then you are free to obtain your own copy of
                the The Attendance Tracker Service code from our{" "}
                <a
                  href="https://github.com/stevecalla/attendance-tracker"
                  target="_self"
                  rel="nofollow noopener"
                ...
                . The The Attendance Tracker Service code is licensed under the
                MIT License. You can then make your own arrangements for
                hosting.
              </p>
              ...
              <p>
                ...
                The Attendance Tracker, we make no representations, warranties
                or guarantees, whether express or implied, that the content on
                The Attendance Tracker is accurate, complete or up to date.
              </p>
              ...
              <p>
                <em>
                  ...
                  or other terms that may apply to The Attendance Tracker or any
                  content on them.
                </em>
              </p>
              <p>
              ...
              <p>
                <em>
                  ...
                  exclusions of liability are reasonable. You accept that it is
                  always possible for you to host your own copy of the{" "}
                  <a
                    href="https://github.com/stevecalla/attendance-tracker"
                    target="_self"
                    rel="nofollow noopener"
              ...
              <p>
                ...
                computer programs and platform to access The Attendance Tracker.
                You should use your own virus protection software.
              </p>
              <p>
                You must not misuse The Attendance Tracker by knowingly
                introducing viruses, trojans, worms, logic bombs or other
                material that is malicious or technologically harmful. You must
                not attempt to gain unauthorised access to The Attendance
                Tracker, the server on which The Attendance Tracker are stored
                or any server, computer or database connected to The Attendance
                Tracker. You must not attack The Attendance Tracker via a
                ...
                use The Attendance Tracker will cease immediately.
              </p>
              <h2>We may make changes to these terms</h2>
              <p>
                We amend these terms from time to time. You should check these
                terms regularly to ensure you understand the terms that apply at
                that time.
              </p>
